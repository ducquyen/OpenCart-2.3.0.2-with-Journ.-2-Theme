...
* @01/2015
* Ajustado para o Banco do Brasil por: Marcelo Mendes
* @02/2015
* Sob licença GPL.
*/
// Heading
$_['heading_title'] = 'Boleto Bancário Banco do Brasil';

// Text
$_['text_payment'] = 'Pagamento';
$_['text_success'] = 'Boleto Bancário Banco do Brasil modificado com sucesso!';
$_['text_edit']    = 'Configurações do Boleto Bancário Banco do Brasil';
$_['text_boleto_bb'] = '<img src="view/image/extension/payment/boleto-bb.png" alt="Boleto Banco do Brasil" title="Boleto Banco do Brasil" style="border: 1px solid #EEEEEE;" /></a>';
...
// Error
$_['error_permission'] = 'ERRO: Voc&ecirc; n&#227;o tem primis&#227;o para modificar Boleto Bancário Banco do Brasil!';
?>