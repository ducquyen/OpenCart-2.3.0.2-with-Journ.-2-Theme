<?php
class ControllerExtensionPaymentBoletocefsigcb extends Controller {
	private $error = array();
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/boleto_cef_sigcb', 'token=' . $this->session->data['token'], 'SSL')
		);

		$data['action'] = $this->url->link('extension/payment/boleto_cef_sigcb', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('extension/payment/boleto_cef_sigcb.tpl', $data));
...
*/
	...
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/payment/boleto_cef_sigcb')) {
			$this->error['warning'] = $this->language->get('error_permission');
		}
