...
$_['text_bank'] = 'Boleto Banco do Brasil';
$_['text_linkboleto'] = '<a href="index.php?route=extension/payment/boleto_bb/callback&order_id=<?php echo $idboleto; ?>" target="_blank">Gerar Segunda Via do Boleto</a>';
