...
<div class="container">
  ...
  <ul class="checkout-bar">
    <li class="<?php if(((((($status == 'Processando')||($status == 'Aguardando Pagamento')||($status == 'Pagamento Confirmado')||($status == 'Enviado')||($status == 'Entregue')||($status == 'Completo'))))))echo 'active';?>">Processando</li>    
    <li class="<?php if((((($status == 'Aguardando Pagamento')||($status == 'Pagamento Confirmado')||($status == 'Enviado')||($status == 'Entregue')||($status == 'Completo')))))echo 'active';?>">Aguardando Pagamento</li>    
    <li class="<?php if(((($status == 'Pagamento Confirmado')||($status == 'Enviado')||($status == 'Entregue')||($status == 'Completo'))))echo 'active';?>">Pagamento Confirmado</li>    
    <li class="<?php if((($status == 'Enviado')||($status == 'Enviado')||($status == 'Entregue')||($status == 'Completo')))echo 'active';?>">Enviado</li>    
    <li class="<?php if(($status == 'Entregue')||($status == 'Completo'))echo 'active';?>">Entregue</li>
	<li class="<?php if($status == 'Completo')echo 'active';?>">Completo</li>
      ...
      <table class="table table-bordered table-hover">
        ...
        <tbody>
          ...
          <?php } ?>
			        ...
			        <?php if (($payment_code == "boleto_bb") && (($histories[(sizeof($histories) - 1)]['status'] == "Aguardando Pagamento") || ($histories[(sizeof($histories) - 1)]['status'] == "Pending")) ) { ?>
			        ...
			        <table class="table table-bordered table-hover">
			          ...
			          <tbody>
			            <tr>
			              ...
			              <td class="text-left"><a href="index.php?route=payment/boleto_bb/callback&order_id=<?php echo $order_id_encryption; ?>" target="_blank">Gerar 2ª Via do Boleto</a></td>
			            </tr>
			          </tbody>
			        </table>
			        <?php } ?>
			        ...
			        <table class="table table-bordered table-hover">
			          ...
			          <tbody>
			            <tr>
			              <td class="text-left"><?php echo $payment_method; ?></td>
			              <td class="text-left"><a href="index.php?route=extension/payment/boleto_cef_sigcb/callback&order_id=<?php echo $order_id_encryption; ?>" target="_blank">Gerar 2ª Via do Boleto</a></td>
			            </tr>
			          </tbody>
			        </table>
			        <?php } ?>
    ...
    <?php echo $column_right; ?></div>
		...
		<style>
/*
classe visited: cor azul
classe active: cor verde 
*/
...
<?php if (($status == 'Processando')||($status == 'Cancelado')){?>
ul.checkout-bar li:nth-child(6):before,ul.checkout-bar li:nth-child(5):before, ul.checkout-bar li:nth-child(4):before, ul.checkout-bar li:nth-child(3):before, ul.checkout-bar li:nth-child(2):before{
<?php } elseif ($status == 'Aguardando Pagamento'){?>
ul.checkout-bar li:nth-child(6):before,ul.checkout-bar li:nth-child(5):before, ul.checkout-bar li:nth-child(4):before, ul.checkout-bar li:nth-child(3):before{
<?php } elseif ($status == 'Pagamento Confirmado'){?>
ul.checkout-bar li:nth-child(6):before,ul.checkout-bar li:nth-child(5):before, ul.checkout-bar li:nth-child(4):before{
<?php } elseif (($status == 'Enviado')||($status == 'Código de Rastreio')){?>
ul.checkout-bar li:nth-child(6):before,ul.checkout-bar li:nth-child(5):before{
