...
.shipping-result {
    ...
    border-bottom: 1px solid #d5dbdb;
	     ...
	     <div class="disponibilidade">
		   <h4><strong><i style="font-size:21px;"class="fa fa-truck"> </i> <?php echo $entry_simulate_shipping;?></strong></h4>
       <div class="form-group">
               <div class="row">
                    <div class="col-md-12">
                           <div class="input-group"> 
      
         <input type="text" value="" style="width:120px; margin-right:3px;" class="form-control" placeholder="<?php echo $entry_postcode;?>" aria-describedby="basic-addon2" name="postcode" id="postcode">
			  <button type="button"  data-loading-text="<?php echo $entry_calculate_loading;?>" id="button-calculate"  class="button btn btn-success"><i class="fa fa-list-alt"></i> <?php echo $entry_calculate_shipping;?></button>
